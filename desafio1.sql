DROP DATABASE IF EXISTS SpotifyClone;
  ...
  INSERT INTO SpotifyClone.users (user_id, name, age, plan, signature_date, status)
  VALUES
    (1, 'Barbara Liskov', 82, 1, '2019-10-20', 1),
    (2, 'Robert Cecil Martin', 58, 1, '2017-01-06', 1),
    (3, 'Ada Lovelace', 37, 4, '2017-12-30', 0),
    (4, 'Martin Fowler', 46, 4, '2017-01-17', 1),
    (5, 'Sandi Metz', 58, 4, '2018-04-29', 1),
    (6, 'Paulo Freire', 19, 2, '2018-02-14', 0),
    (7, 'Bell Hooks', 26, 2, '2018-01-05', 0),
    (8, 'Christopher Alexander', 85, 3, '2019-06-05', 0),
    (9, 'Judith Butler', 45, 3, '2020-05-13', 1),
    (10, 'Jorge Amado', 58, 3, '2017-02-17', 0);
